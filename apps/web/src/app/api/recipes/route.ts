...
const mockRecipes: Recipe[] = [
  ...
  },
  {
    cookingSteps: [
      {
        description:
          '소고기를 불고기 양념에 재워주세요. 최소 30분 이상 재워야 맛이 좋습니다.',
        estimatedTime: 30,
        id: 11,
        stepNumber: 1,
        title: '고기 재우기',
      ...
      {
        description: '양파, 당근, 대파, 양배추를 적당한 크기로 썰어주세요.',
        estimatedTime: 10,
        id: 12,
        stepNumber: 2,
        title: '야채 준비',
      ...
      {
        description:
          '팬에 기름을 두르고 고기를 넣어 볶아주세요. 고기가 익을 때까지 볶습니다.',
        estimatedTime: 8,
        id: 13,
        stepNumber: 3,
        title: '고기 볶기',
      ...
      {
        description: '고기에 야채를 넣고 함께 볶아주세요.',
        estimatedTime: 5,
        id: 14,
        stepNumber: 4,
        title: '야채 넣기',
    ...
    cookingTime: 45,
    description: '달콤한 불고기 만들기',
    difficulty: 'medium',
    id: 3,
    imageUrl: '/recipeImage.png',
    ingredients: [
      { amount: '300', id: 11, name: '소고기', unit: 'g' },
      { amount: '1', id: 12, name: '양파', unit: '개' },
      { amount: '1/2', id: 13, name: '당근', unit: '개' },
      { amount: '2', id: 14, name: '대파', unit: '대' },
      { amount: '1/4', id: 15, name: '양배추', unit: '개' },
    ],
    servings: 4,
    title: '불고기',
  },
