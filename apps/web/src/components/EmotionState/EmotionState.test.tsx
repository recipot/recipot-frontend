...
describe('EmotionContainer', () => {
  ...
  describe('렌더링', () => {
    it('기본 상태에서 올바르게 렌더링된다', () => {
      render(<EmotionContainer {...defaultProps} />);
    ...
    it('초기 감정이 설정된 경우 올바르게 렌더링된다', () => {
      render(<EmotionContainer {...defaultProps} initialMood="good" />);
    ...
    it('커스텀 className이 적용된다', () => {
      const { container } = render(
        <EmotionContainer {...defaultProps} className="custom-class" />
      );
  ...
  describe('감정 선택 기능', () => {
    it('감정 버튼을 클릭하면 onMoodChange가 호출된다', async () => {
      ...
      render(<EmotionContainer onMoodChange={onMoodChange} />);
    ...
    it('같은 감정을 다시 클릭하면 null이 전달된다', async () => {
      ...
      render(
        <EmotionContainer onMoodChange={onMoodChange} initialMood="bad" />
      );
  ...
  describe('배경 그라디언트', () => {
    it('선택된 감정에 따라 올바른 배경 그라디언트가 적용된다', () => {
      ...
      const { container: containerBad } = render(
        <EmotionContainer {...defaultProps} initialMood="bad" />
      );
      ...
      const { container: containerNeutral } = render(
        <EmotionContainer {...defaultProps} initialMood="neutral" />
      );
      ...
      const { container: containerGood } = render(
        <EmotionContainer {...defaultProps} initialMood="good" />
      );
  ...
  describe('접근성', () => {
    it('감정 버튼들이 올바른 접근성 속성을 가진다', () => {
      render(<EmotionContainer {...defaultProps} initialMood="bad" />);
